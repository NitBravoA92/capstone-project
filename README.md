...
- [Live Demo Link](https://nitbravoa92.github.io/capstone-project/index.html)
...
- [x] **Create the mobile version of the Homepage**
- [x] **Create the mobile version of the About page**
- [x] **Create the desktop version of the webpage**
- [x] **Animate some elements of the website with css transition**
...
The main design of the webpage is under [Creative Commons](https://creativecommons.org/licenses/by/2.0/kr/) licensed.
